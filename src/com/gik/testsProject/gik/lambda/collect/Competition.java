package com.gik.testsProject.gik.lambda.collect;
...
class Competition {
    ...
    public static Map<String, Integer> getTeamPlaceMap(Collection<Team> teams) {
      return    teams.stream()
              .sorted(Comparator.comparing(Team::getPlace,Comparator.reverseOrder()))
                .collect(Collectors.toMap(Team::getName, Team::getPlace, (x, y) -> x, LinkedHashMap::new));
